...
### a) เราจะแก้ปัญหาอะไร?
```
แก้ปัญหาการคัดแยกชนิดของมะพร้าวส่งผลกระทบต่อทุกภาคส่วนที่เกี่ยวข้องในห่วงโซ่อุปทาน
```

### b) ใครคือ user หลัก?
```
เกษตรกร ผู้ประกอบการ แรงงาน ผู้บริโภค
...
```
ใช้ได้แม้ไม่มีอินตเอร์เน็ต และ ต้อง response < 1 วินาที
...
```
เครื่องคัดแยกมะพร้าวด้วย AI ช่วยเกษตรกรคัดแยกมะพร้าวโดยอัตโนมัติ
ต่างจาก การคัดมือ เพราะ เป็นระบบอัตโนมัติและลด Human Error
```
...
- จะ improve จาก V2 ตอนนี้อย่างไร?
  ```
  เพิ่มความแม่นย่ำในการตรวจจับวัตถุ
  ```
